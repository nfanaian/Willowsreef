...
if ( ! function_exists( 'storefront_credit' ) ) {
	...
	function storefront_credit() {
		...
		<div class="site-info">
			...
			<br /> <?php printf( esc_attr__( '%1$s designed by %2$s.', 'storefront' ), 'eCommerce Website', '<a href="http://www.cs.ucf.edu/people/profiles.php?id=166" title="UCF" rel="author">a group of Computer Science students from University of Central Florida</a>' ); ?>
			<?php } ?>
		</div><!-- .site-info -->
		<?php
	}
